...
class DigiflazController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->url = env('DIFIFLAZ_URL');
        $this->user = env('DIFIFLAZ_USER');
    ...
    public function digiflazTopup(Request $request)
    {
        ...
        // TES POSTMAN
        // POST https://localhost:8000/api/product/topup/
        // BODY RAW ( JSON ) 
        // {
        //     "sku": "xld10", { sesuai masing masing },
        //     "customer_no": "081234567890", { sesuai masing masing },
        // }
        // RESPONE JSON 14 data
        // {
        //     data : {
        //         // data data
        //     }
