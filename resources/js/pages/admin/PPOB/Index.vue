...
.border-purple {
    border-color: #9461fb !important;
}

.text-purple {
    color: #9461fb !important;
}

.bg-purple-light {
    background-color: rgba(148, 97, 251, 0.1) !important;
}
...
.bg-success-light {
    background-color: rgba(44, 144, 39, 0.1) !important;
}
