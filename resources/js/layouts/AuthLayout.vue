<template>
    ...
    <div
        class="d-flex flex-column flex-column-fluid flex-lg-row h-100"
        :style="`background-image: url('${setting?.bg_auth}'); background-size: cover`"
    >
        <!--begin::Body-->
        <div
            class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end"
        >
            <!--begin::Card-->
            <div
            ...
            >
                <!--begin::Wrapper-->
                <div
                    class="d-flex flex-center flex-column flex-column-fluid px-10 py-md-0"
                >
